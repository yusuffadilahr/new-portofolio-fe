    ...
    return (
        <Box sx={{ width: '100%', display: isTabletMode ? 'none' : 'flex', flexDirection: 'column', minHeight: '100vh', height: 'fit-content' }}>
            ...
            <Box className="w-full min-h-10 h-[300px] rounded-xl relative">
                <Box className="absolute inset-0 flex justify-end p-4 items-center">
                    {/* <h1 className="font-bold">GAS</h1> */}
                    <Box className='w-44 h-44 bg-gradient-to-tr from-white via-sky-400 to-blue-600 rounded-full z-0'></Box>
                </Box>
                ...
                <Image height={500} width={500} src='/images/foto-intro.png'
                    priority alt="Profile Picture" className="h-[300px] w-fit z-40 absolute"/* className="w-[200px] h-[200px] object-cover object-[0_30%]"*/ />
            </Box>
